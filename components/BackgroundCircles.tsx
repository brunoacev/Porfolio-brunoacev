...
const BackgroundCircles = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="border absolute border-red-500 rounded-full h-[300px] w-[300px] mt-52 animate-ping" />

      <div className="border absolute border-red-500 rounded-full h-[400px] w-[400px] mt-52 animate-ping" />
